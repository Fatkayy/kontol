...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        :question: Still need help? [Click Here](https://discord.gg/CkgtMFxU) Join Community REX RIOT Community

question: Still need help? [Click Here](https://discord.gg/CkgtMFxU) Join Community REX RIOT Comunity
*Community ini Bukan Untuk Pamer Skil Atau pun Abuse Tools*  `)
...
let ad = ads.ad[Math.floor((Math.random() * ads.ad.length))];
  if(cooldown.has(message.author.id)){
    ...
    return message.channel.send(`**${message.author.username}** harap tunggu 3 detik untuk menggunakan command ini lagi! \n\n ${ad}`)
  }
...
require('http').createServer((req, res) => res.end(`
 ...
 |-----------------------------------------|
 |• Github: https://replit.com/@RazzelSetiawan/Kayes#index.js |
 |-----------------------------------------|
...
client.user.setActivity(` ${client.guilds.cache.size} servers! ┊K!help┊${client.users.cache.size} user! `, {
    type: "STREAMING"}).catch(console.error)
